...
/**
 * \defgroup dmsrp DMSRP Routing
 *
 * This section documents the API of the ns-3 DMSRP module. For a generic functional description, please refer to the ns-3 manual.
 */
